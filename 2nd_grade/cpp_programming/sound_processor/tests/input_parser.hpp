...
//    for tests
    const std::string get_config_file() { return config_file_; }
    const std::string get_output_file() { return output_file_; }
    const std::vector<std::string> get_input_files() { return input_files_; }
};
